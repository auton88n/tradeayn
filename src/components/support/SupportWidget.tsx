      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="w-[400px] max-w-[calc(100vw-32px)] h-[600px] max-h-[80vh] flex flex-col rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.12),0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Glass panel with accent line */}
            <div className="relative flex flex-col h-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-border/50">
              {/* Top accent line */}
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 min-h-0">
                ...
                <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                  <TabsContent value="chat" className="flex-1 min-h-0 m-0 p-0 data-[state=active]:flex data-[state=active]:flex-col">
                    <AISupportChat onNeedTicket={() => setActiveTab('ticket')} />
                  </TabsContent>
                  <TabsContent value="ticket" className="flex-1 min-h-0 m-0 p-0 overflow-auto">
                    {ticketView === 'list' && (
                      <TicketList
                  ...
                  <TabsContent value="faq" className="flex-1 min-h-0 m-0 p-0 overflow-hidden">
                    <FAQBrowser />
                  </TabsContent>
                </div>
              </Tabs>
