          ...
          <div className="ayn-consultant-card flex items-center gap-3 p-3 rounded-lg bg-gray-50 border border-gray-200 mb-6">
            <div className="ayn-avatar">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                <path d="M12 2c-1.1 0-2.1.4-2.8 1.1C8.4 2.4 7.4 2 6.3 2 4.5 2 3 3.5 3 5.3c0 .6.2 1.2.5 1.7C2.6 7.6 2 8.7 2 10c0 1.1.4 2.1 1.1 2.8-.7.7-1.1 1.7-1.1 2.8 0 1.3.6 2.4 1.5 3.1C3.2 19.3 3 19.9 3 20.5c0 1.4 1.1 2.5 2.5 2.5.6 0 1.2-.2 1.7-.5.6.3 1.2.5 1.8.5 1.1 0 2.1-.4 2.8-1.1.7.7 1.7 1.1 2.8 1.1.6 0 1.2-.2 1.8-.5.5.3 1.1.5 1.7.5 1.4 0 2.5-1.1 2.5-2.5 0-.6-.2-1.2-.5-1.9.9-.7 1.5-1.8 1.5-3.1 0-1.1-.4-2.1-1.1-2.8.7-.7 1.1-1.7 1.1-2.8 0-1.3-.6-2.4-1.5-3.1.3-.5.5-1.1.5-1.7 0-1.8-1.5-3.3-3.3-3.3-1.1 0-2.1.4-2.8 1.1C14.1 2.4 13.1 2 12 2z"/>
                <path d="M12 4c.8 0 1.5.3 2 .8.2-.3.5-.5.8-.6C15.4 4.1 16 4.5 16 5.3c0 .3-.1.6-.3.8.4.3.7.8.7 1.4 0 .5-.2 1-.5 1.3.3.3.5.8.5 1.3 0 .6-.3 1.1-.7 1.4.2.2.3.5.3.8 0 .8-.6 1.2-1.2 1.1-.3-.1-.6-.3-.8-.6-.5.5-1.2.8-2 .8s-1.5-.3-2-.8c-.2.3-.5.5-.8.6-.6.1-1.2-.3-1.2-1.1 0-.3.1-.6.3-.8-.4-.3-.7-.8-.7-1.4 0-.5.2-1 .5-1.3-.3-.3-.5-.8-.5-1.3 0-.6.3-1.1.7-1.4-.2-.2-.3-.5-.3-.8 0-.8.6-1.2 1.2-1.1.3.1.6.3.8.6.5-.5 1.2-.8 2-.8z"/>
              </svg>
            </div>
