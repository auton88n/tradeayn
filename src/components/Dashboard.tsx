          ...
          <div className="ayn-consultant-card flex items-center gap-3 p-3 rounded-lg bg-gray-50 border border-gray-200 mb-6">
            <div className="ayn-avatar">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                <path d="M19.5 12c0-2.23-.82-4.22-2.16-5.69.02-.25.16-.64.16-.95 0-.39-.13-.78-.4-1.06-.27-.28-.64-.43-1.02-.43-.36 0-.7.13-.95.37-.44-.18-.92-.3-1.42-.35C13.1 2.68 11.64 2 10 2s-3.1.68-3.71 1.89c-.5.05-.98.17-1.42.35-.25-.24-.59-.37-.95-.37-.38 0-.75.15-1.02.43-.27.28-.4.67-.4 1.06 0 .31.14.7.16.95C1.32 7.78.5 9.77.5 12c0 2.23.82 4.22 2.16 5.69-.02.25-.16.64-.16.95 0 .39.13.78.4 1.06.27.28.64.43 1.02.43.36 0 .7-.13.95-.37.44.18.92.3 1.42.35.61 1.21 2.07 1.89 3.71 1.89s3.1-.68 3.71-1.89c.5-.05.98-.17 1.42-.35.25.24.59.37.95.37.38 0 .75-.15 1.02-.43.27-.28.4-.67.4-1.06 0-.31-.14-.7-.16-.95 1.34-1.47 2.16-3.46 2.16-5.69zM12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
