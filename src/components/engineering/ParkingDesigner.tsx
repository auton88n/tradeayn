    ...
    try {
      ...
      printContent.innerHTML = `
        <div style="padding: 20px; font-family: Arial, sans-serif; color: #333;">
          ...
          <div style="margin-top: 15px; padding-top: 10px; border-top: 1px solid #ddd; color: #999; font-size: 11px; text-align: right;">
            <p style="margin: 0;">Report generated on ${new Date().toLocaleDateString()}</p>
          </div>
        </div>
      `;
