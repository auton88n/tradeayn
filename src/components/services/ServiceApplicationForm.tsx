  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        'https://dfkoxuokfkttjhfjcecx.supabase.co/functions/v1/send-application',
        {
          method: 'POST',
          headers: {
    ...
    return (
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            setIsSuccess(false);
            setFormData({ fullName: '', email: '', phone: '', message: '', customFields: {} });
          }}
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              {field.type === 'select' && field.options ? (
                <select
                  ...
                  className="w-full h-10 px-3 rounded-md bg-neutral-800/50 border border-neutral-700 text-white focus:border-neutral-500 focus:outline-none focus:ring-1 focus:ring-neutral-500"
                >
                ...
                <Textarea
                  ...
                  rows={3}
                  className="bg-neutral-800/50 border-neutral-700 text-white placeholder:text-neutral-500 focus:border-neutral-500 resize-none"
                />
              ) : (
                <Input
                  value={formData.customFields[field.name] || ''}
        ...
        <Button
          ...
          className="w-full h-12 text-lg font-semibold text-white transition-all duration-300"
          style={{
      ...
      <div className="mt-8 pt-6 border-t border-neutral-800 text-center">
        <p className="text-neutral-500 text-sm mb-3">Prefer email?</p>
        <button
          type="button"
          onClick={handleCopyEmail}
          className="inline-flex items-center gap-2 text-neutral-300 hover:text-white transition-colors group"
        >
          <Mail className="w-4 h-4" />
          <span>info@aynn.io</span>
          {copied ? (
