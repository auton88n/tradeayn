...
const roles = [
  { icon: Users, label: 'HR', iconColor: 'text-blue-500' },
  { icon: Headphones, label: 'Support', iconColor: 'text-emerald-500' },
  { icon: TrendingUp, label: 'Sales', iconColor: 'text-violet-500' },
  { icon: Calculator, label: 'Finance', iconColor: 'text-amber-500' },
  { icon: FileText, label: 'Admin', iconColor: 'text-orange-500' },
  { icon: MessageCircle, label: 'Social', iconColor: 'text-pink-500' },
];
  ...
  return (
    <div className="relative w-full h-full min-h-[320px] flex items-center justify-center" dir="ltr">
      ...
      <div className="absolute z-20 flex items-center justify-center">
        ...
        <div 
          className="absolute w-28 h-28 rounded-full border border-cyan-400/20 animate-spin-slow"
          style={{
