      ...
      <div className="relative">
        ...
        >
          ...
          <div className="flex gap-4">
            <div>
              <p className="text-rose-400 font-bold text-xl">1.1M</p>
              <p className="text-neutral-500 text-[9px] flex items-center gap-1"><Users className="w-3 h-3" /> Followers</p>
            </div>
            <div>
              <p className="text-rose-400 font-bold text-xl">6.8%</p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-base font-bold text-rose-400">+24%</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex gap-4">
            <div>
              <p className="text-rose-400 font-bold text-xl">2.1M</p>
              <p className="text-neutral-500 text-[9px] flex items-center gap-1"><Users className="w-3 h-3" /> Followers</p>
            </div>
            <div>
              <p className="text-rose-400 font-bold text-xl">12.3%</p>
              <p className="text-neutral-500 text-[9px] flex items-center gap-1"><Heart className="w-3 h-3" /> Engagement</p>
            </div>
            <div>
              <p className="text-white font-bold text-xl">500K</p>
              <p className="text-neutral-500 text-[9px] flex items-center gap-1"><Eye className="w-3 h-3" /> Avg Views</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex gap-3">
            <div className="bg-neutral-800/70 rounded-xl px-3 py-2 text-center">
              <p className="text-white font-bold text-lg">68%</p>
              <p className="text-rose-400 text-[8px]">Female</p>
            </div>
            <div className="bg-neutral-800/70 rounded-xl px-3 py-2 text-center">
              <p className="text-white font-bold text-lg">82%</p>
              <p className="text-neutral-400 text-[8px]">Age 18-34</p>
            </div>
          </div>
        </motion.div>
      </div>
