...
const MobileMockup = () => {
  ...
  return <div className="relative flex justify-center items-center py-8 px-4 md:px-16 lg:px-32">
      ...
      <div className="relative mx-auto">
        ...
        <motion.div 
          className="absolute top-4 right-[-80px] md:right-[-110px] lg:right-[-140px] bg-neutral-900/95 backdrop-blur-sm shadow-xl rounded-xl p-2 md:p-2.5 border border-neutral-800 z-20 cursor-pointer hidden sm:block"
        ...
        >
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 md:w-7 md:h-7 rounded-lg bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center">
              <Instagram className="w-3 h-3 md:w-3.5 md:h-3.5 text-white" />
            </div>
            <div>
              <p className="text-white font-semibold text-[9px] md:text-[10px]">Instagram</p>
              <p className="text-neutral-500 text-[7px]">Social Platform</p>
            </div>
          </div>
          <div className="flex gap-2 md:gap-2.5">
            <div>
              <p className="text-[#E1306C] font-bold text-xs md:text-sm">1.1M</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Users className="w-2 h-2" /> Followers</p>
            </div>
            <div>
              <p className="text-[#E1306C] font-bold text-xs md:text-sm">6.8%</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Heart className="w-2 h-2" /> Engage</p>
            </div>
            <div>
              <p className="text-white font-bold text-xs md:text-sm">150K</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Eye className="w-2 h-2" /> Views</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          className="absolute bottom-24 right-[-60px] md:right-[-80px] lg:right-[-100px] bg-neutral-900/95 backdrop-blur-sm shadow-lg rounded-lg p-1.5 md:p-2 border border-neutral-800 z-20 cursor-pointer hidden sm:block"
        ...
        >
          <div className="flex items-center gap-1.5">
            ...
            <div>
              <p className="text-[8px] md:text-[9px] text-neutral-500">Engagement</p>
              <p className="text-[10px] md:text-xs font-bold text-emerald-400">+24%</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 bg-neutral-900/95 backdrop-blur-sm shadow-lg rounded-full px-2.5 md:px-3 py-1 md:py-1.5 border border-neutral-800 flex items-center gap-1 md:gap-1.5 z-20 cursor-pointer"
        ...
        >
          <TrendingUp className="w-2.5 h-2.5 md:w-3 md:h-3 text-emerald-400" />
          <p className="text-[8px] md:text-[9px] text-neutral-300 whitespace-nowrap">Top 5% Engagement in Fashion</p>
        </motion.div>

        {/* TikTok Card - Top Left */}
        <motion.div 
          className="absolute top-[-10px] left-[-80px] md:left-[-110px] lg:left-[-140px] bg-neutral-900/95 backdrop-blur-sm shadow-xl rounded-xl p-2 md:p-2.5 border border-neutral-800 z-20 hidden md:block cursor-pointer"
          initial={{ scale: 0.8, opacity: 0, x: -20 }}
          whileInView={{ scale: 1, opacity: 1, x: 0 }}
          whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}
        ...
        >
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 md:w-7 md:h-7 rounded-lg bg-neutral-800 flex items-center justify-center">
              <svg className="w-3 h-3 md:w-3.5 md:h-3.5 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
              </svg>
            </div>
            <div>
              <p className="text-white font-semibold text-[9px] md:text-[10px]">TikTok</p>
              <p className="text-neutral-500 text-[7px]">Social Platform</p>
            </div>
          </div>
          <div className="flex gap-2 md:gap-2.5">
            <div>
              <p className="text-[#00f2ea] font-bold text-xs md:text-sm">2.1M</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Users className="w-2 h-2" /> Followers</p>
            </div>
            <div>
              <p className="text-[#00f2ea] font-bold text-xs md:text-sm">12.3%</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Heart className="w-2 h-2" /> Engage</p>
            </div>
            <div>
              <p className="text-white font-bold text-xs md:text-sm">500K</p>
              <p className="text-neutral-500 text-[6px] flex items-center gap-0.5"><Eye className="w-2 h-2" /> Views</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          className="absolute bottom-16 left-[-70px] md:left-[-90px] lg:left-[-120px] bg-neutral-900/95 backdrop-blur-sm shadow-lg rounded-xl p-2 md:p-2.5 border border-neutral-800 z-20 hidden lg:block cursor-pointer"
          initial={{ scale: 0.8, opacity: 0, x: -20 }}
          whileInView={{ scale: 1, opacity: 1, x: 0 }}
          whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}
          ...
          viewport={{ once: true }}
        >
          <p className="text-white font-semibold text-[8px] md:text-[9px] mb-1.5">Audience Demographics</p>
          <div className="flex gap-1.5">
            <div className="bg-neutral-800/70 rounded-lg px-1.5 md:px-2 py-1 text-center">
              <p className="text-white font-bold text-xs md:text-sm">68%</p>
              <p className="text-[#E1306C] text-[6px]">Female</p>
            </div>
            <div className="bg-neutral-800/70 rounded-lg px-1.5 md:px-2 py-1 text-center">
              <p className="text-white font-bold text-xs md:text-sm">82%</p>
              <p className="text-neutral-400 text-[6px]">Age 18-34</p>
            </div>
          </div>
        </motion.div>
      </div>
