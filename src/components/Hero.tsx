      ...
      <div className="relative w-full max-w-5xl mt-8 flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="absolute left-6 md:left-16 lg:left-24 bottom-6 md:bottom-20 w-[170px] md:w-[220px] rounded-2xl backdrop-blur-xl bg-background/55 border border-border/30 shadow-[0_10px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.3)] p-4"
          >
          ...
          <motion.div
            ...
            className="absolute top-8 md:top-6 w-[150px] md:w-[200px] rounded-2xl backdrop-blur-xl bg-background/55 border border-border/30 shadow-[0_10px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.3)] p-3"
          ...
          <motion.div
            ...
            className="absolute right-6 md:right-16 lg:right-24 bottom-6 md:bottom-20 w-[170px] md:w-[220px] rounded-2xl backdrop-blur-xl bg-background/55 border border-border/30 shadow-[0_10px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.3)] p-4"
          >
            <div className="text-sm md:text-base font-medium text-foreground">
              {CARDS[2]}
            </div>
