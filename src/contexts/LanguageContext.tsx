...
const translations = {
  en: {
    ...
    'tutorial.steps.eye.description': 'This is AYN, your AI assistant. Watch how the eye changes color based on emotion and follows your cursor.',
  ...
  ar: {
    ...
    'tutorial.steps.eye.description': 'هذا هو AYN، مساعدك الذكي. شاهد كيف يتغير لون العين حسب المشاعر ويتبع مؤشرك.',
