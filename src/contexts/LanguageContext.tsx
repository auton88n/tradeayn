...
const translations = {
  en: {
    ...
    'admin.auditLogging': 'Enable Audit Logging',
    'admin.auditLoggingDesc': 'Log all administrative actions',
    'admin.rateLimit': 'Rate Limit (per minute)',
    'admin.rateLimitDesc': 'Maximum requests per minute per user',
    'admin.maxSessions': 'Max Concurrent Sessions',
    'admin.maxSessionsDesc': 'Maximum simultaneous sessions per user',
  ...
  ar: {
    ...
    'admin.auditLogging': 'تمكين تسجيل التدقيق',
    'admin.auditLoggingDesc': 'تسجيل جميع الإجراءات الإدارية',
    'admin.rateLimit': 'حد المعدل (في الدقيقة)',
    'admin.rateLimitDesc': 'الحد الأقصى للطلبات في الدقيقة لكل مستخدم',
    'admin.maxSessions': 'الحد الأقصى للجلسات المتزامنة',
    'admin.maxSessionsDesc': 'الحد الأقصى للجلسات المتزامنة لكل مستخدم',
