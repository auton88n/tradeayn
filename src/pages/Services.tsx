        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {services.map((service, index) => (
              <ScrollAnimation key={index} variant="scaleIn" delay={index * 0.15}>
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:scale-105 transition-all duration-300 h-full">
                  ...
                  <Button 
                    ...
                    className="w-full bg-white/10 text-white hover:bg-white/20 hover:scale-105 border border-white/20 transition-all"
                  >
          ...
          <ScrollAnimation variant="fadeUp" delay={0.5}>
            <div 
              className="relative rounded-2xl p-8 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-2 border-transparent bg-clip-padding hover:scale-105 transition-transform duration-300"
              style={{
