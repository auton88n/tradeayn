          ...
          duration: 0.6
            ...
            <div className="md:hidden">
              ...
              <div className="grid grid-cols-4 gap-3">
                {integrations.map((integration, index) => <motion.div key={integration.name} className={`w-12 h-12 ${integration.color} rounded-xl flex items-center justify-center shadow-lg mx-auto`} initial={{
                opacity: 0,
                scale: 0
              }} whileInView={{
                opacity: 1,
            ...
            <div className="hidden md:flex justify-center mt-8 mb-16">
              <div className="relative">
                ...
                <div className="absolute w-[200px] h-[200px] -top-[68px] -left-[68px]">
                  ...
                  return <motion.div key={integration.name} className={`absolute w-10 h-10 ${integration.color} rounded-lg flex items-center justify-center shadow-lg`} style={{
